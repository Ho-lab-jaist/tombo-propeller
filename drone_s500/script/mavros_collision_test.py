...
class MavrosOffboardPosctl(MavrosFunction):
	...
	start_pos = [0, 0, 0]
	connect_pos = [0., -0.09, 1.99]
	collision_pos = [1.708, -0.011, 1.99] #1.475, -0.163, 2.05
	reponse_pos = [0.9, 0.20, 1.99]

	# reach_position(start_pos[0], start_pos[1], start_pos[2], 10)
	self.reach_position(connect_pos[0], connect_pos[1], connect_pos[2], 35)
	self.to_collision(collision_pos[0], collision_pos[1], collision_pos[2], 10)
	self.reach_position(reponse_pos[0], reponse_pos[1], reponse_pos[2], 15)
